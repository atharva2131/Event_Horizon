...
class _AccountSettingsScreenState extends State<AccountSettingsScreen> {
  ...
  void _saveChanges() {
    // Simulate saving with a loading indicator
    showDialog(
      context: context,
    ...
    Future.delayed(const Duration(seconds: 2), () {
      ...
      Navigator.pop(context, {
        ...
        'profilePicture': _imageFile != null ? _imageFile!.path : profilePicture,
      });
            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const SizedBox(height: 16),
                  _buildTextField('Email Address', _emailController, Icons.email, _isEditing),
                  const SizedBox(height: 16),
